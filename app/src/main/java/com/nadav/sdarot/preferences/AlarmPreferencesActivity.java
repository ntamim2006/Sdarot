...
import com.nadav.sdarot.BaseActivity;
import com.nadav.sdarot.R;
import com.nadav.sdarot.database.Database;
import com.nadav.sdarot.preferences.AlarmPreference.Key;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null && bundle.containsKey("adapter")) {
			setListAdapter((AlarmPreferenceListAdapter) bundle.getSerializable("adapter"));
				...
				setListAdapter(new AlarmPreferenceListAdapter(this, getMathAlarm(), name));
		}

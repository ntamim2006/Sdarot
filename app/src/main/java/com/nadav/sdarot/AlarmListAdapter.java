...
public class AlarmListAdapter extends BaseAdapter {
	...
	public static final String ALARM_FIELDS[] = { Database.COLUMN_ALARM_ACTIVE,
			Database.COLUMN_ALARM_TIME, Database.COLUMN_ALARM_DAYS, Database.COLUMN_ALARM_NAME };
...
//		alarms = Database.getAll();
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		TextView alarmNamesView = (TextView) view
				.findViewById(R.id.textView18);
		alarmNamesView.setText(alarm.getAlarmName());

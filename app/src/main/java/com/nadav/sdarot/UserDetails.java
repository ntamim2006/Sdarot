...
public class UserDetails extends Fragment implements Button.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_user_details, container, false);
        ...
        Button btnChangeEmail = (Button) rootView.findViewById(R.id.change_email_button);
        Button btnChangePassword = (Button) rootView.findViewById(R.id.change_password_button);
        Button btnSendResetEmail = (Button) rootView.findViewById(R.id.sending_pass_reset_button);
